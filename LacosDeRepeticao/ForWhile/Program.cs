...
namespace ForWhile
{
    class Program
    {
        ...
        /// <summary>
        /// O método busca dentro da aplição
        /// </summary>
        /// <param name="wordToFind"> Parâmetro para 3 caracteres </param>
        /// <returns>Retorna a quantidade encontrada da expressão</returns>
        private static int FindByFor(string wordToFind)
        {
        ...
        /// <summary>
        /// ESTE MÉTODO RETORNA UM GRANDE TEXTO
        /// </summary>
        /// <returns>O CONTEÚDO EM STRING</returns>
        private static string TextContent()
        {
          ...
          Percebemos, cada vez mais, que o julgamento imparcial das eventualidades talvez venha a ressaltar a relatividade das regras de conduta normativas. Por outro lado, a execução dos pontos do programa estimula a padronização das condições financeiras e administrativas exigidas. O empenho em analia crescente influência da mídia acarreta um processo de reformulação e modernização dos relacionamentos verticais entre as hierarquias.";
        }
    }
}
