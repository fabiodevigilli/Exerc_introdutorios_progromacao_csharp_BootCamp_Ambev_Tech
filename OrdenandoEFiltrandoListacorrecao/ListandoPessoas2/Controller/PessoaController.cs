...
namespace ListandoPessoas2.Controller
{
    ...
    private List <Pessoa> ListaDePessoas { get; set; }
        /// <summary>
        /// O MÉTODO CONSTRUTOR AJUDA A INICIAR A NOSSA CLASSE PARA UTILIZARMOS DE MANEIRA CORRETA AS INFORMAÇÕES INTERNAS,
        /// COM ISSO PODEMOS INICIAR NOSSA LISTA DE PESSOAS SEM DEPENDER DO USUÁRIO OU PROGRAMADOR NA PARTE DA INTERFACE
        /// </summary>
        public PessoaController()
        {
            //INICIAMOS A LISTA DE PESSOAS DENTRO DO NOSS MÉTODO CONSTRUTOR
        ...
        /// não damos acesso para alterar a lista fora da classe
        /// apenas visualização
        /// </summary>
        public List<Pessoa> ListaDePessoasPublic
        {
            //No get podemos retornar propriedades privadas
        ...
        /// </summary>
        /// <returns>Retornamos o valor já ordenada de nossa lista</returns>
        ...
        /// <summary>
        /// Método retorna a lista de pessoas com idade maior que idade
        /// informada 
        /// </summary>
